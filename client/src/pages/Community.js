        ...
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Welcome to the Community Board
              </h1>
...
/* TO ADD */
// dropdown menus for post topic (food request, restock, new items, psa), location
// feature for users to reply to each other's posts
// if there is time, add a like feature