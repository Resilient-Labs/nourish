...
export default function Home() {
  const fridgeData = [
    // figure out how to fetch that data. For now i cant fetch it until backend makes the endpoint
    {
      ...
      fridgeImage:
        "https://img.freepik.com/free-vector/illustration-gallery-icon_53876-27002.jpg?size=626&ext=jpg&ga=GA1.1.1428990738.1703065310&semt=sph", //ADD
      fridgeContact: {
        phoneNumber: "",
        email: "",
        volunteerURL: "",
